...
st.set_page_config(
    page_title="Gemini-powered AI Learning Companion",
    page_icon="logo.png",
    layout="centered",
)
...
if selected == "About":
    st.title("About This Gemini-powered AI Learning Companion")
    st.markdown("**Made by 😎 [Saurabh Kumar](https://www.linkedin.com/in/saurabh-kumar-mr-java-web-developer-885524224/)**")
